...
async def start(message: types.Message):
    ...
    await message.bot.send_message(message.from_user.id, "Привет! Я бот, разработанный группой КС-28 'MUJIKI', " + \
                                   "университета РХТУ им. Д.И.Менделеева. " + \
                                   "\nУ меня две основные функции. " + \
                                   "\nЭто ведение расходов/доходов и менеджер задач", reply_markup=nav.mainMenu)
